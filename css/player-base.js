...
      vOk = !videoEl.paused || vOk;
      aOk = !audio.paused || aOk;
...
        }
      } else if (!vOk && !aOk) {
        // Let syncLoop handle retries or subsequent pause attempts to prevent blocking
      }
...
    } finally {
      syncing = false;
      // Remainder handling gracefully deferred to syncLoop to allow non-blocking behavior
    }
  }
